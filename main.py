...
def load_llm(groq_api_key):
    llmModel = ChatGroq(temperature=0.7,model="llama3-70b-8192", api_key=groq_api_key)
    return llmModel
...
with col2:
    st.write("Hello, It's me Suyesh")

st.markdown("## Enter your GROQ API key")

def get_groq_api_key():
    input_text=st.text_input(label="GROQ API Key ",  placeholder="Ex: gsk_euXLPpIQlMXi...", key="groq_api_key_input", type="password")
    return input_text
